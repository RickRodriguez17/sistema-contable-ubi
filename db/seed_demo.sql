...
-- (Opcional. Carga 3 asientos aprobados para tener datos en los reportes.)
-- ============================================================
USE contaubi;
...
(@c1, (SELECT id FROM cuentas WHERE codigo='11020101'), 50000, 0, 'Depósito aporte socios', 1),
(@c1, (SELECT id FROM cuentas WHERE codigo='31010100'), 0, 50000, 'Capital inicial', 2);

-- 2) Compra de equipo de computación — 8,400 Bs al contado
INSERT INTO comprobantes (numero, tipo, fecha, glosa, moneda, estado, total_debe, total_haber)
VALUES ('2026-000002','EGRESO','2026-01-15','Compra de 3 computadoras para oficina','Bs.','APROBADO',8400,8400);
SET @c2 = LAST_INSERT_ID();
INSERT INTO movimientos (comprobante_id, cuenta_id, debe, haber, glosa_linea, orden) VALUES
(@c2, (SELECT id FROM cuentas WHERE codigo='14030100'), 8400, 0, 'Equipos PC', 1),
(@c2, (SELECT id FROM cuentas WHERE codigo='11020101'), 0, 8400, 'Pago con cheque', 2);

-- 3) Venta de servicios — 12,000 Bs cobrados al contado
INSERT INTO comprobantes (numero, tipo, fecha, glosa, moneda, estado, total_debe, total_haber)
VALUES ('2026-000003','INGRESO','2026-02-05','Servicios prestados marzo 2026','Bs.','APROBADO',12000,12000);
SET @c3 = LAST_INSERT_ID();
INSERT INTO movimientos (comprobante_id, cuenta_id, debe, haber, glosa_linea, orden) VALUES
(@c3, (SELECT id FROM cuentas WHERE codigo='11010101'), 12000, 0, 'Cobranza en efectivo', 1),
(@c3, (SELECT id FROM cuentas WHERE codigo='41020100'), 0, 12000, 'Servicios prestados', 2);
...
INSERT INTO movimientos (comprobante_id, cuenta_id, debe, haber, glosa_linea, orden) VALUES
(@c4, (SELECT id FROM cuentas WHERE codigo='52010100'), 5000, 0, 'Sueldos febrero', 1),
(@c4, (SELECT id FROM cuentas WHERE codigo='11020101'), 0, 5000, 'Pago vía banco', 2);
